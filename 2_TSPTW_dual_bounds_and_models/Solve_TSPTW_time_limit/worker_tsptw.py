...
try:
    ...
    import tsptw_domain # Uses your new domain
...
if __name__ == "__main__":
    try:
        ...
        n, c, r, d = tsptw_domain.read_tsptw_format(file_path)
        tsptw_domain.current_num_locations = n
        tsptw_domain.current_travel_cost = c
        tsptw_domain.current_avail_time = r
        tsptw_domain.current_due_date = d
        ...
        result = combining_modified_didppy_solver_with_chromosome(
            ...
            didp_model_registry=tsptw_domain.creation_of_didp_model_function,
            dual_bound_expression_function=tsptw_domain.dual_bound_expression_function,
