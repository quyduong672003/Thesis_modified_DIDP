...
sys.path.append(os.getcwd()) # For tsp_domain
...
if __name__ == "__main__":
    try:
        ...
        # Setup Model
        model, metadata = tsp_domain.creation_of_didp_model_function()

        # Setup Dual Bound from Chromosome
        chromosome = ast.literal_eval(chromosome_str)
        dual_bound_funcs = tsp_domain.dual_bound_expression_function((model, metadata))
