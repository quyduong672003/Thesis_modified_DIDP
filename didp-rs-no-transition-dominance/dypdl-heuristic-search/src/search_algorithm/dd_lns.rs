    ...
    Transition: From<V>,
{
    ...
    pub fn new(
        ...
        DdLns {
            ...
            time_keeper,
            first_call: true,
            expansion_limit: parameters.beam_search_parameters.parameters.expansion_limit,
        }
    }
    ...
    pub fn search_inner(&mut self) -> (Solution<T, TransitionWithId<V>>, bool) {
        ...
        loop {
            ...
            self.expansion_limit = self
                .expansion_limit
                .map(|limit| limit.saturating_sub(solution.expanded));
            ...
            if solution.time_out || self.expansion_limit == Some(0) {
                if !solution.time_out && !self.quiet {
                    println!("Reached the expansion limit.");
                }
