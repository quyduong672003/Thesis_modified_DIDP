    ...
    Transition: From<V>,
{
    ...
    pub fn new(
        ...
        let mut time_keeper: util::TimeKeeper = parameters
            .time_limit
        ...
        Dfbb {
            ...
            time_keeper,
            solution,
            expansion_limit: parameters.expansion_limit,
        }
    }
    ...
    Transition: From<V>,
{
    fn search_next(&mut self) -> Result<(Solution<T>, bool), Box<dyn Error>> {
        ...
        while let Some(node) = self.open.pop() {
            ...
            let time_out = self.time_keeper.check_time_limit(self.quiet);
            ...
            {
                if !time_out && !self.quiet {
                    println!("Reached the expansion limit.");
                }

                self.solution.time_out = time_out;
