...
/// It uses a parallel beam search algorithm, hash distributed beam search 2 (HDBS2), instead of sequential beam search.
...
///     BeamSearchParameters, CabsParameters, create_dual_bound_lnhdbs2, FEvaluatorType,
...
///
/// let threads = 1;
/// let mut solver = create_dual_bound_lnhdbs2(
...
/// ```
pub fn create_dual_bound_lnhdbs2<T>(
